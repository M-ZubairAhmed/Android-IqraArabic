...
public class RawData {
    ...
    private String[] colorsArray_ar = {"abyad", "eswid", "dahabi", "ahmar", "azra", "akhzar", "asfar", "fadi", "boni", "burtuqani"};

    private int[] colorsImageArray = {R.drawable.color_white, R.drawable.color_black, R.drawable.color_gold, R.drawable.color_red, R.drawable.color_blue, R.drawable.color_green, R.drawable.color_yellow,
            R.drawable.color_gray, R.drawable.color_brown, R.drawable.color_orange};

    private int[] colorsSoundsArray = {R.raw.colors_ar_white,R.raw.colors_ar_black,R.raw.colors_ar_gold,R.raw.colors_ar_red,R.raw.colors_ar_blue,R.raw.colors_ar_green,R.raw.colors_ar_yellow,R.raw.colors_ar_grey,
            R.raw.colors_ar_brown,R.raw.colors_ar_orange};

    protected String[] getNumbersArray_En() {
        return numbersArray_En;
    }

    protected String[] getNumbersArray_Ar() {
        return numbersArray_Ar;
    }

    protected int[] getNumbersArray_rm(){
        return numbersArray_rm;
    }

    protected String[] getFamilyArray_en() {
        return familyArray_en;
    }

    protected String[] getFamilyArray_ar() {
    ...
    protected String[] getColorsArray_en() {
        return colorsArray_en;
    }

    protected String[] getColorsArray_ar() {
        return colorsArray_ar;
    }

    protected int[] getColorsImageArray() {
        return colorsImageArray;
    }

    protected int getColorsCount() {
        return colorsArray_en.length;
    }

    public int[] getColorsSoundsArray() {
        return colorsSoundsArray;
    }
}
